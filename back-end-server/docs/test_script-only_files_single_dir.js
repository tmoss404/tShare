...
xhttp.send(JSON.stringify({
    loginToken: theLoginToken,
    dirPath: "your new\\directory/newer directory"
}));
...
xhttp.send(JSON.stringify({
    loginToken: theLoginToken,
    path: "your new\\directory/file.txt",
    isDirectory: false
}));
...
xhttp.send(JSON.stringify({
loginToken: theLoginToken,
filePath: "your new\\directory/newer directory/file.txt",
fileType: "text/plain"
}));
